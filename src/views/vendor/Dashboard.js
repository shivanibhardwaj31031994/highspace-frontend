        ...
        <section className="col-12 vendor-section">
	        <div className="row">
		        ...
		        <div className="col-md-9 vendor-form">
                    <div className="form-title sp-2">Dashboard</div>
		            <div className="row">
		                <div className="col-md-7 vendor-form">
                            ...
                            <div className="sec-title">Latest Booking Requests</div>
                        ...
                        {[...Array(2)].map((key,val)=>
                            <div className="vendor-box style-1" key={val}>
                                <div className="row">
                                            ...
                                            <div className="media-body">
                                                ...
                                                <div className="d-flex">
                                                    <div className="align-self-end">
                                                        <a href="#" className="link">View Request<i className="fa fa-chevron-circle-right icon"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-sm-3 d-flex flex-wrap">
                                        <div className="w-100">
                                            <button className="btn style-1 btn-block">Accept</button>
                                        </div>
                                        <div className="w-100 d-flex">
                                            <button className="align-self-end btn style-1 clr-1 btn-block">Reject</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="vendor-box style-1">
                                <div className="row">
                                    <div className="col-sm-9">
                                        <div className="row">
                                            <div className="col-sm-6 d-flex pr-0">
                                                <div className="w-100 detail-box">
                                                    <div className="d-title">Lorem ipsum dolor</div>
                                                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Laborum perspiciatis error dolorem blanditiis veritatis eos necessitatibus aliquam</p>
                                                </div>
                                    ...
                                    <div className="col-sm-3 d-flex flex-wrap">
                                        <div className="w-100">
                                            <button className="btn style-1 clr-1 btn-block">Clear All</button>
                                        </div>
                                        <div className="w-100 d-flex">
                                            <button className="align-self-end btn style-1 clr-1 btn-block">More</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
