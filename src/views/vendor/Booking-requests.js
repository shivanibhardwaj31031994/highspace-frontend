        ...
        <section className="col-12 vendor-section">
	        <div className="row">
		        ...
		        <div className="col-md-9 vendor-form">
                    <div className="form-title sp-2">Booking Requests</div>
		            <div className="row">
		                <div className="col-md-7 vendor-form">
                            ...
                            <div className="sec-title">Your Booking Requests</div>
                                            ...
                                            <div className="media-body">
                                                ...
                                                <div className="d-flex">
                                                    <div className="align-self-end">
                                                        <a href="#" className="link">Expand<i className="fa fa-chevron-circle-down icon"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
